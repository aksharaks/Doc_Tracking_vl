...
namespace Doc_Tracking_vl.Models
{
    public class Req_GL_ABH
    {
        ...
        public LoanDocRequ_Mortgage_ABH_GL LoanDocsReq_gl_abh { get; set; }
        
    }
    public class LoanDocRequ_Mortgage_ABH_GL
    {
        public List<LoanDoc_ABH_gl> LoanDocs { get; set; }
    }
    public class LoanDoc_ABH_gl
    {
    ...
    public class Req_LoanDoc_Mort_gl_abh
    {
